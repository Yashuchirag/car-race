...
**Last completed:** Scenery for all six circuits (section 3, WIP): countryside, mountains,
desert, coast, city, and the night neon city with floodlights and headlights.

**Next action:** Your look at Desert Park, Ise Bay, Northants and the Airfield. Known weak
point: Ise Bay's sea only shows as a band past the barriers along the southern part.
