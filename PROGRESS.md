...
**Last completed:** Restart race and Main menu from the pause menu and the results screen
(section 3, WIP), after a bridge where Ise Bay crosses itself.

**Next action:** Your check of the pause menu's new buttons and the four new themes. Open:
the AI runs wide at Ise Bay's 130R (section 6).
