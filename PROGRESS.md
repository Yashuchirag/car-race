...
**Last completed:** Countryside scenery on Royal Park (section 3, WIP): stands, garages,
billboards and banner towers, and about 23,000 trees drawn instanced. 135 fps on High.

**Next action:** Your look at Royal Park's scenery. Once agreed, the other five themes in
turn: Ardennes mountains and forest, Desert Park desert, Ise Bay coast, Northants city,
Airfield night neon city, each with its own sky, fog and ground where the theme needs it.
