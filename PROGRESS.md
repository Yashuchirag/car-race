...
**Next action:** The circuits drive in Unity, walled in, with a keyboard steering assist. Your choice next: lap timing in Unity, AI cars in Unity, finishing Phase 0 (Git LFS and a standalone build above 200 fps), or passing lanes (section 3, TODO). Passing lanes, the
